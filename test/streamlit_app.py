...
class BlackScholes:
    ...
    def calculate_prices(
        ...
        d_neg = d_pos - volatility * sqrt(time_to_maturity)

        call_price = current_price * norm.cdf(d_pos) - (
        ...
        self.put_delta = 1 - norm.cdf(d_pos)
...
#calculating P&L for the call and the put
